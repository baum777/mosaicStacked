...
## [2026-05-29] openrouter-production-readiness-guard | added a read-only production OpenRouter readiness smoke that checks `/models`, `/settings/openrouter/status`, and `/api/settings/openrouter/status` without calling `/chat` or spending provider credits [[../scripts/openrouter-production-readiness.mjs]] [[../server/test/openrouter-production-readiness.test.ts]] [[../package.json]] [[../docs/smoke-test-matrix.md]]

## [2026-06-08] swarm-governance-bootstrap | added 3-agent swarm governance contract slice under ops/agent-team/ with swarm roles, policy, task routing, review gate, team plan, agent memory, and MSPR logbook; routed through 03-mspr/packets/2026-06-08-swarm-governance-bootstrap.yml for human review [[../ops/agent-team/README.md]] [[../ops/agent-team/swarm_roles.md]] [[../ops/agent-team/swarm_policy.md]] [[../ops/agent-team/swarm_task_routing.md]] [[../ops/agent-team/swarm_review_gate.md]] [[../ops/agent-team/agent_teamplan.md]] [[../ops/agent-team/agent_memory.md]] [[../ops/agent-team/mspr_logbook.md]] [[../03-mspr/packets/2026-06-08-swarm-governance-bootstrap.yml]]

## [2026-06-08] extended-roles-v1-adoption | adopted optional opt-in extended role library from model-agnostic-workflow-system/docs/agent-teams/ (11 specialized roles + 5 default presets); 3-Agent-Core bleibt kanonisch; swarm_roles.md + agent_memory.md + mspr_logbook.md erweitert [[../ops/agent-team/swarm_roles]] [[../ops/agent-team/agent_memory]] [[../ops/agent-team/mspr_logbook]]

## [2026-06-18] block-f-performance-bundle | MarkdownMessage/GuideOverlay/LandingPage lazy-loaded; useRuntimeStatus split into useSettingsWorkspaceStatus; useVirtualScroll on long lists; 5 useMemo coalesced into currentSurfaceState; LandingPage extracted to web/src/landing/. 34 new tests. [[../web/src/components/ChatWorkspace.tsx]] [[../web/src/components/MatrixWorkspace.tsx]] [[../web/src/components/SessionList.tsx]] [[../web/src/hooks/useRuntimeStatus.ts]] [[../web/src/hooks/useSettingsWorkspaceStatus.ts]] [[../web/src/hooks/useVirtualScroll.ts]] [[../web/src/landing/LandingPage.tsx]] [[../web/vite.config.ts]] [[../web/src/App.tsx]] [[../CHANGELOG.md]]

## [2026-06-18] block-g-test-hardening | 7 matrix-api validators tested; companion-context redaction property-tested; chat-workflow cancel/recovery/notice-ring/reducer-action-matrix tested; workspace-state edge cases tested; matrix-gates table-driven; shell-freshness truth-table tested; new ErrorBoundary class component + shell-telemetry sink + 3 Suspense-level wraps. 40 new tests. 3 BLOCKED items: pinned-chat-context.ts does not redact secret tokens; web/src/lib/shell-freshness.ts disagrees with spec on case 3; web/src/lib/matrix-api.ts validateExecutionResponse is dead code. [[../web/src/components/ErrorBoundary.tsx]] [[../web/src/lib/shell-telemetry.ts]] [[../web/src/lib/matrix-api.ts]] [[../web/src/lib/shell-freshness.ts]] [[../web/src/lib/companion-context.ts]] [[../web/src/lib/pinned-chat-context.ts]] [[../web/src/lib/matrix-gates.ts]] [[../web/src/lib/workspace-state.ts]] [[../web/src/lib/chat-workflow.ts]] [[../CHANGELOG.md]]
